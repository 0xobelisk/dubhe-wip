  ...
  module test_project::test_project_balance {
  ...
  const TABLE_NAME: vector<u8> = b"balance";
  ...
  public fun has(dapp_hub: &DappHub, asset: address, account: address): bool {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&asset));
    key_tuple.push_back(to_bytes(&account));
    dapp_service::has_record<DappKey>(dapp_hub, get_table_id(), key_tuple)
  }

  public fun ensure_has(dapp_hub: &DappHub, asset: address, account: address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&asset));
    key_tuple.push_back(to_bytes(&account));
  ...
  public fun ensure_not_has(dapp_hub: &DappHub, asset: address, account: address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&asset));
    key_tuple.push_back(to_bytes(&account));
  ...
  public fun delete(dapp_hub: &mut DappHub, asset: address, account: address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&asset));
    key_tuple.push_back(to_bytes(&account));
  ...
  public fun get(dapp_hub: &DappHub, asset: address, account: address): u256 {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&asset));
    key_tuple.push_back(to_bytes(&account));
  ...
  public fun set(dapp_hub: &mut DappHub, asset: address, account: address, value: u256) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&asset));
    key_tuple.push_back(to_bytes(&account));
