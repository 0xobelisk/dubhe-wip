  ...
  module test_project::test_component {
  ...
  const TABLE_NAME: vector<u8> = b"test_component";

  public struct TestComponent has copy, drop, store {
    player: address,
    value: u32,
  }

  public fun new(player: address, value: u32): TestComponent {
    TestComponent {
            player,
            value,
        }
  ...
  public fun player(self: &TestComponent): address {
    self.player
  }

  public fun value(self: &TestComponent): u32 {
    self.value
  }

  public fun update_player(self: &mut TestComponent, player: address) {
    self.player = player
  }

  public fun update_value(self: &mut TestComponent, value: u32) {
    self.value = value
  }
  ...
  public fun has_player(dapp_hub: &DappHub, entity_id: address): bool {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
    dapp_service::has_field<DappKey>(dapp_hub, get_table_id(), key_tuple, 0)
  }

  public fun ensure_has_player(dapp_hub: &DappHub, entity_id: address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
    dapp_service::ensure_has_field<DappKey>(dapp_hub, get_table_id(), key_tuple, 0)
  }

  public fun ensure_not_has_player(dapp_hub: &DappHub, entity_id: address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
    dapp_service::ensure_not_has_field<DappKey>(dapp_hub, get_table_id(), key_tuple, 0)
  }

  public fun has_value(dapp_hub: &DappHub, entity_id: address): bool {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
    dapp_service::has_field<DappKey>(dapp_hub, get_table_id(), key_tuple, 1)
  }

  public fun ensure_has_value(dapp_hub: &DappHub, entity_id: address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
    dapp_service::ensure_has_field<DappKey>(dapp_hub, get_table_id(), key_tuple, 1)
  }

  public fun ensure_not_has_value(dapp_hub: &DappHub, entity_id: address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun get_player(dapp_hub: &DappHub, entity_id: address): address {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun get_value(dapp_hub: &DappHub, entity_id: address): u32 {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun get(dapp_hub: &DappHub, entity_id: address): (address, u32) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun get_struct(dapp_hub: &DappHub, entity_id: address): TestComponent {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
    let value_tuple = dapp_service::get_record<DappKey>(dapp_hub, get_table_id(), key_tuple);
    decode(value_tuple)
  ...
  public fun encode_struct(test_component: TestComponent): vector<vector<u8>> {
    encode(test_component.player, test_component.value)
  }

  public fun decode(data: vector<u8>): TestComponent {
