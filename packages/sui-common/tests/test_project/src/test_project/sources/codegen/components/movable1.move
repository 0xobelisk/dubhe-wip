  ...
  module test_project::test_project_movable1 {
  ...
  public fun get(dapp_hub: &DappHub, id: address): (address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&id));
  ...
  public fun set(dapp_hub: &mut DappHub, id: address, value: address) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&id));
