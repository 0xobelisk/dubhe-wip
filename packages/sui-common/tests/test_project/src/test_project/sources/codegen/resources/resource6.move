  ...
  public fun delete(dapp_hub: &mut DappHub, player: address, id1: u32, id2: u32) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&player));
    key_tuple.push_back(to_bytes(&id1));
    key_tuple.push_back(to_bytes(&id2));
  ...
  public fun set_value1(dapp_hub: &mut DappHub, player: address, id1: u32, id2: u32, value1: u32) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&player));
    key_tuple.push_back(to_bytes(&id1));
    key_tuple.push_back(to_bytes(&id2));
  ...
  public fun set_value2(dapp_hub: &mut DappHub, player: address, id1: u32, id2: u32, value2: u32) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&player));
    key_tuple.push_back(to_bytes(&id1));
    key_tuple.push_back(to_bytes(&id2));
  ...
  public fun set(dapp_hub: &mut DappHub, player: address, id1: u32, id2: u32, value1: u32, value2: u32) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&player));
    key_tuple.push_back(to_bytes(&id1));
    key_tuple.push_back(to_bytes(&id2));
  ...
  public fun set_struct(dapp_hub: &mut DappHub, player: address, id1: u32, id2: u32, resource6: Resource6) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&player));
    key_tuple.push_back(to_bytes(&id1));
    key_tuple.push_back(to_bytes(&id2));
