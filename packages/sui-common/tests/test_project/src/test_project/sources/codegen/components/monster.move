  ...
  public fun get(dapp_hub: &DappHub, entity_id: address): (u64, u64, u64) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun set(dapp_hub: &mut DappHub, entity_id: address, attack: u64, defense: u64, hp: u64) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun get_struct(dapp_hub: &DappHub, entity_id: address): Monster {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
    let value_tuple = dapp_service::get_record<DappKey>(dapp_hub, get_table_id(), key_tuple);
    decode(value_tuple)
  ...
  public fun set_struct(dapp_hub: &mut DappHub, entity_id: address, monster: Monster) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
