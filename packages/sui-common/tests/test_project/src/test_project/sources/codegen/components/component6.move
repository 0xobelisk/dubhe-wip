  ...
  public fun set_attack(dapp_hub: &mut DappHub, entity_id: address, attack: u32) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun set_hp(dapp_hub: &mut DappHub, entity_id: address, hp: u32) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun set(dapp_hub: &mut DappHub, entity_id: address, attack: u32, hp: u32) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
  ...
  public fun set_struct(dapp_hub: &mut DappHub, entity_id: address, component6: Component6) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&entity_id));
