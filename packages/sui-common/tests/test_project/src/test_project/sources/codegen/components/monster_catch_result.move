  ...
  module test_project::monster_catch_result {
  ...
  use test_project::status::{Status};
  ...
  public fun get(dapp_hub: &DappHub, monster: address): Status {
    ...
    let value = test_project::status::decode(&mut bsc_type);
    value
  }
  ...
  public fun encode(value: Status): vector<vector<u8>> {
    ...
    value_tuple.push_back(test_project::status::encode(value));
    value_tuple
  }
}
