...
async function init() {
  ...
  const res1 = (await dubhe.tx.counter_system.increase()) as PendingTransactionResponse;
  ...
  const res2 = (await dubhe.tx.counter_system.increase()) as PendingTransactionResponse;
