  ...
  public struct Dapp_metadata has copy, drop, store {
    name: vector<u8>,
  ...
  public fun name(self: &Dapp_metadata): vector<u8> {
    self.name
  }

  public fun description(self: &Dapp_metadata): vector<u8> {
    self.description
  }

  public fun website_url(self: &Dapp_metadata): vector<u8> {
    self.website_url
  }

  public fun cover_urls(self: &Dapp_metadata): vector<vector<u8>> {
    self.cover_urls
  }

  public fun partners(self: &Dapp_metadata): vector<vector<u8>> {
    self.partners
  }

  public fun package(self: &Dapp_metadata): address {
    self.package
  }

  public fun created_at(self: &Dapp_metadata): u64 {
    self.created_at
  }

  public fun version(self: &Dapp_metadata): u32 {
    self.version
  }

  public fun update_name(self: &mut Dapp_metadata, name: vector<u8>) {
    self.name = name
  }

  public fun update_description(self: &mut Dapp_metadata, description: vector<u8>) {
    self.description = description
  }

  public fun update_website_url(self: &mut Dapp_metadata, website_url: vector<u8>) {
    self.website_url = website_url
  }

  public fun update_cover_urls(self: &mut Dapp_metadata, cover_urls: vector<vector<u8>>) {
    self.cover_urls = cover_urls
  }

  public fun update_partners(self: &mut Dapp_metadata, partners: vector<vector<u8>>) {
    self.partners = partners
  }

  public fun update_package(self: &mut Dapp_metadata, package: address) {
    self.package = package
  }

  public fun update_created_at(self: &mut Dapp_metadata, created_at: u64) {
    self.created_at = created_at
  }

  public fun update_version(self: &mut Dapp_metadata, version: u32) {
  ...
  public fun get_struct(dapp_hub: &DappHub, dapp_key: vector<u8>): Dapp_metadata {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&dapp_key));
    let value_tuple = dapp_service::get_record<DappKey>(dapp_hub, get_table_id(), key_tuple);
    decode(value_tuple)
  ...
  public fun set_struct(dapp_hub: &mut DappHub, dapp_key: vector<u8>, dapp_metadata: Dapp_metadata) {
    let mut key_tuple = vector::empty();
    key_tuple.push_back(to_bytes(&dapp_key));
  ...
  public fun encode_struct(dapp_metadata: Dapp_metadata): vector<vector<u8>> {
  ...
  public fun decode(data: vector<u8>): Dapp_metadata {
