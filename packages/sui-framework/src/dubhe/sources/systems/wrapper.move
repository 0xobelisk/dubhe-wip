...
//       let pool_balance = dapp_hub.mut_dapp_store_objects(dapp_key).borrow_mut<address, Balance<T>>(asset_id);
...
//       let dapp_key = dapp_key::new();
//       dapp_hub.mut_dapp_store_objects(dapp_key).add(asset_id, balance::zero<T>());
//       asset_id
// }
