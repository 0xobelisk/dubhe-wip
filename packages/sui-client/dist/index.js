...
var BasicBcsTypes = {
  ...
  "0x2::coin::Coin<T>": import_bcs2.bcs.struct("Coin", {
    id: import_bcs2.bcs.fixedArray(32, import_bcs2.bcs.u8()).transform({
      input: (id) => (0, import_bcs2.fromHex)(id),
      output: (id) => (0, import_bcs2.toHex)(Uint8Array.from(id))
    }),
    balance: import_bcs2.bcs.struct("Balance", {
      value: import_bcs2.bcs.u64()
    })
  }),
  "0x2::balance::Balance<T>": import_bcs2.bcs.struct("Balance", {
    value: import_bcs2.bcs.u64()
  })
};
