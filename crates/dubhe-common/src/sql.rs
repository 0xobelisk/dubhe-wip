...
impl DBData {
    pub fn new(table_name: String, column_name: String, column_type: String, column_value: ParsedMoveValue, is_primary_key: bool) -> Self {
        Self { table_name, column_name, column_type, column_value, is_primary_key }
    }
}
