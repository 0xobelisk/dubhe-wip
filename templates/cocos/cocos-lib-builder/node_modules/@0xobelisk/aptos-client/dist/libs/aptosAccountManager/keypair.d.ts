 ...
 */
export declare const getDerivePathForAPTOS: (derivePathParams?: DerivePathParams) => string;
/**
 ...
 * @param derivePathParams
 */
export declare const getKeyPair: (mnemonics: string, derivePathParams?: DerivePathParams) => AptosAccount;
