...
To start off let's create your Dubhe project from a template by running the following pnpm command.
...
At this point you will see the option of choosing a template—as of writing the three options are **101**, **web**, **contract**.
